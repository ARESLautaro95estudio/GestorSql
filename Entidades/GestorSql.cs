...
namespace Entidades
{
    public static class GestorSql
    {
        ...
        /// <summary>
        /// Modifica un dato de la tabla, te pedira la columna, el dato nuevo
        /// y la columna y el dato para identificar que se desea cambiar.
        /// Llama al medotodo consultarDatos.
        /// </summary>
